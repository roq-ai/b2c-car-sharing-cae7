  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience effortless mobility with B2C Car Sharing - Where individual customers meet available cars, all managed seamlessly from a centralized dashboard."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience effortless mobility with B2C Car Sharing - Where individual customers meet available cars, all managed seamlessly from a centralized dashboard.`}
            </Text>
            <Box
